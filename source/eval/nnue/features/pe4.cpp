...
IndexType PE4::MakeIndex(BonaPiece p, int effect1, int effect2) {
  return p + (static_cast<IndexType>(fe_end) * (effect1 * 2 + effect2));
}

// 駒の情報を取得する
inline void PE4::GetPieces(
