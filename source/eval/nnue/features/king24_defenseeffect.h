...
#ifndef _NNUE_FEATURES_KING24_DEFENSEEFFECT_H_
#define _NNUE_FEATURES_KING24_DEFENSEEFFECT_H_
...
// 特徴量King24DefenseEffect：玉の24近傍の利き数（受け方）
template <Side AssociatedKing>
class King24DefenseEffect {
 public:
  // 特徴量名
  static constexpr const char* kName =
      (AssociatedKing == Side::kFriend) ? "King24DefenseEffect(Friend)" : "King24DefenseEffect(Enemy)";
  // 評価関数ファイルに埋め込むハッシュ値
